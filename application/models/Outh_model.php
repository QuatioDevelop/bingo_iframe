...
class Outh_model extends CI_Model {
	...
	public function Encrypt($string) {
		$cryptKey  = ":jC!a-rfk9GFEg^7(*6LPDhrH?V!+gzYb|tS+-&}M!hnG9=#],p3= kMu|5+tFmy";
	...
	public function Encryptor($action, $string) {
		...
		$secret_key = 'hitenVkawd%:bTXz,3r>6|FW#!7eSs>vM~n+48~{Mh$#L8p).)#wV3^_y-B.6CWar=b4.';
		$secret_iv = '3w8XD|r@n:nxp|uml]nw$-KEx|rT$H).(~ &`gnV!vD0vz|?r]#Zdr-qRlOV@&#6';
	...
	{  
		$options = array("cost"=>12,'salt'=>'F#&eW*<K}_jIlx5>^RmY5{nAiR;8+JiFhSkuJZMB^W:pU2}`@8xb6%pU-5p_:MYp');
