            ...
            <div class="row">
              ...
              <div class="col-lg-6 center">
                <div class="p-5">
                      ...
                      if ($today < $bingoDate) : ?>
                            <div class="jumbotron jumbotron-fluid" style="color: black;">
                              <div class="container">
                                ...
                                <p class="lead">Aún no se ha habilitado el ingreso al Bingo, por favor vuelve a ingresar en un momento.</p>
                              </div>
                            </div>
                      <?php else: ?>
                  ...
                  <!--div class="text-center">
                    <a class="btn btn-info" href="<?= base_url() ?>register">Regístrate</a>
                  </div-->
                      <?php endif; ?>
               </div>
              </div>
