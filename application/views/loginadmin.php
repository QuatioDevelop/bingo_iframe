...
<head>
  ...
  <title>Bingo Virtual - Login Admin</title>
...
<body class="bg-gradient-primary">
  ...
  <div class="container">
              ...
              <div class="col-lg-6 center">
                <div class="p-5">
                  ...
                  <?php if($this->session->flashdata("error")):?>
  		            ...
  		            <?php endif; ?>
                  <form class="user" action="<?= base_url() ?>login/iniciarsesionadmin" method="post">
    ...
    <a href="https://api.whatsapp.com/send?phone=<?php echo $this->config->item('supportnumber'); ?>&text=Hola,%20estoy%20en%20el%20login%20y%20necesito%20soporte%20en%20el%20bingo%20<?php echo get_set_name(); ?>." class="float" target="_blank"><i class="fab fa-fw fa-whatsapp my-float"></i></a>
  </div>
