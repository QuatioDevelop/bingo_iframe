...
if (confirm("¿Realmente desea reiniciar el juego?"))  {
		location.href=base_url+'admin/bingo/restart';
...
function ConfigConfirmation() {
	...
	if (confirm("Cambiar la configuración reiniciará el juego.  ¿Quiere continuar?"))  {
		return true;
	} else return false;
}
